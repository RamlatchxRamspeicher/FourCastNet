...
class AFNO2D(nn.Module):
    def __init__(self, hidden_size, num_blocks=8, sparsity_threshold=0.01, hard_thresholding_fraction=1, hidden_size_factor=1, mp_size=1):
        ...
        self.block_size = ((self.hidden_size // mp_size) // self.num_blocks)
...
class Block(nn.Module):
    def __init__(
        ...
        self.filter = AFNO2D(dim, num_blocks//mp_size, sparsity_threshold, hard_thresholding_fraction, mp_size=mp_size) 
